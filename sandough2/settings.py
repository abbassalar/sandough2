"""
Django settings for sandough2 project.
...
SECRET_KEY = 'django-insecure-gnoxzveu897=#92=3ai+qke-+ntzl@uy*i4%e$(*+#)^ooz%6d'
...
WSGI_APPLICATION = 'sandough2.wsgi.application'
